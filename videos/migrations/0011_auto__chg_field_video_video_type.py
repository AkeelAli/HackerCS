...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('videos_video', 'video_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Type'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Video.video_type'
        db.alter_column('videos_video', 'video_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default='Unspecified', to=orm['videos.Type']))
    ...
    models = {
        ...
        'videos.video': {
            ...
            'video_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.Type']", 'null': 'True', 'blank': 'True'}),
