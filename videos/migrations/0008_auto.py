...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field module_prereqs on 'Module'
        db.create_table('videos_module_module_prereqs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_module', models.ForeignKey(orm['videos.module'], null=False)),
            ('to_module', models.ForeignKey(orm['videos.module'], null=False))
        ))
        db.create_unique('videos_module_module_prereqs', ['from_module_id', 'to_module_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field module_prereqs on 'Module'
        db.delete_table('videos_module_module_prereqs')
